...
def help():
    print("Для начала вам нужно ввести цыфру под которым стоит желаемое действие.")
    print("Далее нужно сделать соответсвующее действие (то что вы выбрали).")
    print("И так из раза в раз повторять эти действия пока не проиграете")
    print("        или выиграете.")
